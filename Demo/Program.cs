       ...
       class Program
    {
        ...
        private void _Main()
        {
            ...
            try
            {
                ...
                vsoDoc = vsoApp.Documents.Open(@"c:\temp\test.vsdx");
                GetAllPages(vsoDoc);
        ...
        private void GetConnectedShapes(Shape vsoShape)
        {
            Shape vsoOutShape;
            int outNodes;
        ...
        private void GetAllPages(Document vsoDoc)
        {
            ...
            {
                Console.WriteLine(string.Format("Page is:{0} and ID is : {1}", InPage.Name, InPage.ID));
                
                foreach (Shape InShape in InPage.Shapes)
                {
                    GetConnectedShapes(InShape);
